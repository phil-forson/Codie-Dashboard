...
const defaultMessages: Array<MessageModel> = [
  ...
  },
  {
    user: 4,
    type: 'in',
    text: 'You can unwatch this repository immediately by clicking here: <a href="https://oyalist.com">oyalist.com</a>',
    time: '3 Hours',
  },
  {
    user: 2,
...
const defaultUserInfos: Array<UserInfoModel> = [
  ...
  {
    name: 'Philemon Forson',
    avatar: 'avatars/300-1.jpg',
    email: 'forsonphilemon1@gmail.com',
